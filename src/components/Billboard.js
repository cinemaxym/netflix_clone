            ...
            <Card className="bg-dark text-white" style={{
                ...
                <Card.ImgOverlay className='container-overlay'>
                    ...
                    <div className='billboard-button-layer'>
                        <Button variant="light" className='play-btn' id='play-btn'> <img src={playIcon} /><span>  Play</span></Button>{' '}
                        <Button variant="secondary" className='more-btn' id='more-btn'><img src={infoIcon} /><span>  More info</span></Button>
                    </div>
                </Card.ImgOverlay>
            </Card>
        </div>
