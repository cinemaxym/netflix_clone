import '../style/footer.css' //imports footer.css
...
function Footer() {
    return (
        <div className="member-footer">
            ...
            <div>
                <a className="member-footer-link" href="https://www.netflix.com/browse">
...
export default Footer; //exports Footer to import 